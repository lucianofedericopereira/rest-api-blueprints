"""
Domain event bus — core infrastructure, no dependency on any domain module.
DomainEvent base class lives in app.domain.users.events; this module only
references it via the generic TypeVar so the dependency flows correctly:
  domain → core  (not: core → domain)
"""
